...
int evaluate(char sequance[][15])
{
	...
	for (int i = 0; i <= 72; i++)
	{
		...
		//10000
		score += (15000 * find(sequance[i], huosi1, 6));
		...
		score += (1500 * find(sequance[i], huosan1, 5));
		...
		score -= (1000 * find(sequance[i], huosan1_p, 5));
		score += (1000 * find(sequance[i], huosan2_p, 6));
		score += (1000 * find(sequance[i], huosan3_p, 6));
		//100
		...
		score -= (100 * find(sequance[i], huoer1_p, 4));
		score -= (100 * find(sequance[i], huoer2_p, 5));
		//10
